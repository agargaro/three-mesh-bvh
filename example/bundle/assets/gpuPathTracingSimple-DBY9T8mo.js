import{W as h,S as M,D as x,A as b,P as g,T as y,M as S,d as P,a3 as H,j as m,e as O}from"./ExtendedTriangle-DttZ0GEf.js";import{O as W}from"./OrbitControls-DQHRq1PO.js";import{F as R}from"./Pass-CaVSXokZ.js";import{S as A}from"./stats.min-GTpOrGrX.js";import{g as C}from"./lil-gui.module.min-Bc0DeA9g.js";import{M as _,S as j}from"./MeshBVH-CC82V9eu.js";import{M as D,F,c as L,b as N,a as T}from"./bvh_struct_definitions.glsl-Dd67uX4-.js";import"./_commonjsHelpers-Cpj98o6Y.js";const a={enableRaytracing:!0,animate:!0,resolutionScale:1/window.devicePixelRatio,smoothNormals:!0};let e,i,o,n,u,d,s,f;z();w();function z(){e=new h({antialias:!1}),e.setPixelRatio(window.devicePixelRatio),e.setClearColor(594970),e.setSize(window.innerWidth,window.innerHeight),e.outputEncoding=void 0,document.body.appendChild(e.domElement),o=new M;const r=new x(16777215,1);r.position.set(1,1,1),o.add(r),o.add(new b(11583173,.5)),i=new g(75,window.innerWidth/window.innerHeight,.1,50),i.position.set(0,0,4),i.far=100,i.updateProjectionMatrix(),u=new A,document.body.appendChild(u.dom);const t=new y(1,.3,300,50),c=new _(t,{maxLeafTris:1,strategy:j});s=new S(t,new P),o.add(s),f=new O;const l=new H({defines:{SMOOTH_NORMALS:1},uniforms:{bvh:{value:new D},normalAttribute:{value:new F},cameraWorldMatrix:{value:new m},invProjectionMatrix:{value:new m},invModelMatrix:{value:new m}},vertexShader:`
